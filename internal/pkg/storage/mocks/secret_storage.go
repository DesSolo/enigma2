...
func (_m *SecretStorage) GetInfo(ctx context.Context) string {
	ret := _m.Called(ctx)
...
// SecretStorage_GetInfo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetInfo'
type SecretStorage_GetInfo_Call struct {
	*mock.Call
}

// GetInfo is a helper method to define mock.On call
//   - ctx context.Context
func (_e *SecretStorage_Expecter) GetInfo(ctx interface{}) *SecretStorage_GetInfo_Call {
	return &SecretStorage_GetInfo_Call{Call: _e.mock.On("GetInfo", ctx)}
}

func (_c *SecretStorage_GetInfo_Call) Run(run func(ctx context.Context)) *SecretStorage_GetInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *SecretStorage_GetInfo_Call) Return(_a0 string) *SecretStorage_GetInfo_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SecretStorage_GetInfo_Call) RunAndReturn(run func(context.Context) string) *SecretStorage_GetInfo_Call {
	_c.Call.Return(run)
	return _c
}
...
// Save provides a mock function with given fields: ctx, key, message, dues
func (_m *SecretStorage) Save(ctx context.Context, key string, message string, dues int) error {
	ret := _m.Called(ctx, key, message, dues)
...
//   - message string
//   - dues int
func (_e *SecretStorage_Expecter) Save(ctx interface{}, key interface{}, message interface{}, dues interface{}) *SecretStorage_Save_Call {
	return &SecretStorage_Save_Call{Call: _e.mock.On("Save", ctx, key, message, dues)}
}

func (_c *SecretStorage_Save_Call) Run(run func(ctx context.Context, key string, message string, dues int)) *SecretStorage_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *SecretStorage_Save_Call) RunAndReturn(run func(context.Context, string, string, int) error) *SecretStorage_Save_Call {
	_c.Call.Return(run)
	return _c
}
